  ...
  create or replace view `project-for-method-dw`.`revenue`.`v_trials`
  OPTIONS(
      description="""One row per Method account that began a trial. Source: revenue.Account,\nfiltered to IsConversionException = FALSE, Partner != 'Method\nIntegration', SignupDate != DATE('0001-01-01'). The filter logic lives\nin the BQ-side DDL of v_trials, not this dbt model \u2014 this file is a\npassthrough that exists to let dbt attach the semantic_model below.\n"""
    )
  as 
