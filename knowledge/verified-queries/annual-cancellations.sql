-- ============================================================
-- Annual Cancellations (Pre-FX, CompanyAccount level)
-- ============================================================
-- MRR lost from customers that had positive SaaS 12 months ago
-- but zero now. Excludes OtherChurn (prepay-only customers).
-- Join by EntityRecordID (stable), classify at CompanyAccount.
--
-- Verified 2026-03-27 — EXACT MATCH:
--   Nov 2025: BQ $90,465.24 = Excel $90,465.24
--   Dec 2025: BQ $88,189.56 = Excel $88,189.56
-- ============================================================
