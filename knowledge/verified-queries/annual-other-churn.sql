-- ============================================================
-- Annual OtherChurn (Pre-FX, CompanyAccount level)
-- ============================================================
-- MRR from customers that went to zero year-over-year, but
-- whose ONLY SaaS lines were Prepay Expiry Income. Deferred
-- revenue recognition, not real churn. Separated from
-- Cancellations. Join by EntityRecordID, classify at CompanyAccount.
--
-- Verified 2026-03-27 — EXACT MATCH:
--   Nov 2025: BQ $9,995.75 = Excel $9,995.75
--   Dec 2025: BQ $10,531.00 = Excel $10,531.00
-- ============================================================
