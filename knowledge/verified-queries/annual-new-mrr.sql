-- ============================================================
-- Annual New MRR (Pre-FX, CompanyAccount level)
-- ============================================================
-- MRR from customers that had zero SaaS 12 months ago but
-- positive now. New customers (or returning after a 12+ month gap).
-- Join by EntityRecordID (stable), classify at CompanyAccount.
--
-- Verified 2026-03-27 — EXACT MATCH:
--   Nov 2025: BQ $195,359.57 = Excel $195,359.57
--   Dec 2025: BQ $198,077.84 = Excel $198,077.84
-- ============================================================
