-- ============================================================
-- Monthly Cancellations (Pre-FX, CompanyAccount level)
-- ============================================================
-- MRR lost from customers that had positive SaaS in P1 but zero
-- in P2. Excludes OtherChurn (prepay-only customers).
-- Join by EntityRecordID (stable), classify at CompanyAccount.
--
-- Verified 2026-03-27 — EXACT MATCH:
--   Feb 2026: BQ $17,774.85 = Excel $17,774.85
--   Oct 2025: BQ $9,645.14 = Excel $9,645.14
-- ============================================================
