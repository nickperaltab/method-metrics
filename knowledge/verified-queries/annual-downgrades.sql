-- ============================================================
-- Annual Downgrades (Pre-FX, CompanyAccount level)
-- ============================================================
-- MRR lost from customers that had positive SaaS in both the
-- current month and same month 12 months ago, but current < prior.
-- Downgrade amount = P1 - P2.
-- Join by EntityRecordID (stable), classify at CompanyAccount.
--
-- Verified 2026-03-27 — EXACT MATCH:
--   Nov 2025: BQ $63,103.16 = Excel $63,103.16
--   Dec 2025: BQ $60,131.72 = Excel $60,131.72
-- ============================================================
