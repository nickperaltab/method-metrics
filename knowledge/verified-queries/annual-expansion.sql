-- ============================================================
-- Annual Expansion (Pre-FX, CompanyAccount level)
-- ============================================================
-- MRR gained from customers that had positive SaaS in both the
-- current month and same month 12 months ago, and current > prior.
-- Expansion amount = P2 - P1.
-- Join by EntityRecordID (stable), classify at CompanyAccount.
--
-- Verified 2026-03-27 — EXACT MATCH:
--   Nov 2025: BQ $83,704.09 = Excel $83,704.09
--   Dec 2025: BQ $79,865.91 = Excel $79,865.91
-- ============================================================
