-- ============================================================
-- Monthly Expansion (Pre-FX, CompanyAccount level)
-- ============================================================
-- MRR gained from customers that had positive SaaS in both P1
-- and P2, and P2 > P1. Expansion amount = P2 - P1.
-- Join by EntityRecordID (stable), classify at CompanyAccount.
--
-- Verified 2026-03-27 — EXACT MATCH:
--   Feb 2026: BQ $18,578.84 = Excel $18,578.84
--   Oct 2025: BQ $15,290.67 = Excel $15,290.67
-- ============================================================
