...
-- Do not edit this file — it is a historical capture.
--
-- The view's actual schema (17 columns, customer-month grain):
--   Month, EntityRecordID, Company, p1_saas, p2_saas, StartMRR,
--   Cancellations, Downgrades, Expansions, NewMRR,
--   Segment, UserTier, HasDEP, AttributionChannel, SignupCountry,
--   Vertical, SyncType
--
-- Methodology: CEO-confirmed symmetric Prepay Expiry exclusion (2026-04-28),
-- per knowledge/verified-queries/v_customer_mrr.sql header.
