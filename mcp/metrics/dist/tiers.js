 ...
 */
export const APPROVED_INTERMEDIATES = [
...
export const INTERMEDIATE_WARNING = "Not one of the 20 verified metrics — analysis-model grain and caveats apply; check column docs before quoting.";
