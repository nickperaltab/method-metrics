...
const disposerRegister = (typeof FinalizationRegistry === 'undefined' ? null : new FinalizationRegistry(disposer => disposer()));
export class VizSpecStore {
    ...
    showFieldConfigPanel = false;
    fieldConfigTarget = null;
    defaultConfig;
    onMetaChange;
    constructor(meta, options) {
        ...
        const disposer = reaction(() => this.currentVis, () => {
            document.dispatchEvent(new CustomEvent('edit-graphic-walker', {
                detail: {
    ...
    editEncodingField(stateKey, index, patch) {
    ...
    setShowFieldConfigPanel(show) {
        this.showFieldConfigPanel = show;
        if (!show) {
            this.fieldConfigTarget = null;
        }
    }
    openFieldConfig(channel, index) {
