...
export declare class VizSpecStore {
    ...
    showFieldConfigPanel: boolean;
    fieldConfigTarget: {
        channel: keyof Omit<DraggableFieldState, 'filters'>;
        index: number;
    } | null;
    ...
    get layout(): {
        ...
        scale?: import("../interfaces").IConfigScaleSet | undefined;
        resolve: {
            x?: boolean | undefined;
            y?: boolean | undefined;
        ...
        showAllGeoshapeInChoropleth?: boolean | undefined;
        renderer?: "vega-lite" | "observable-plot" | undefined;
    };
    ...
    editEncodingField(stateKey: keyof Omit<DraggableFieldState, 'filters'>, index: number, patch: Partial<IViewField>): void;
    ...
    setShowFieldConfigPanel(show: boolean): void;
    openFieldConfig(channel: keyof Omit<DraggableFieldState, 'filters'>, index: number): void;
