...
export const VizApp = observer(function VizApp(props) {
    const { computation, darkMode = 'light', i18nLang = 'en-US', enhanceAPI, i18nResources, themeKey = 'vega', themeConfig, vizThemeConfig, toolbar, geographicData, computationTimeout = 60000, spec, chart, vlSpec, onError, hideSegmentNav, hideProfiling, } = props;
    ...
    useEffect(() => {
        if (vlSpec) {
            ...
            vizStore.replaceNow(VegaliteMapper(vlSpec, [...emptyChart.encodings.dimensions, ...emptyChart.encodings.measures], vizStore.currentVis.visId, vizStore.currentVis.name ?? 'Chart 1'));
        }
    }, [vlSpec, vizStore]);
    ...
    return (React.createElement(ErrorContext, { value: { reportError } },
        React.createElement(ErrorBoundary, { fallback: React.createElement("div", null, "Something went wrong"), onError: props.onError },
            React.createElement(VizAppContext, { ComputationContext: wrappedComputation, themeContext: darkMode, vegaThemeContext: { vizThemeConfig: currentTheme, setVizThemeConfig: setCurrentTheme }, portalContainerContext: portal },
                React.createElement("div", { className: classNames(`App font-sans bg-background text-foreground m-0 p-0 w-full h-full`, darkMode === 'dark' ? 'dark' : '') },
                    React.createElement(FieldsContextWrapper, null,
                        React.createElement("div", { className: "bg-background text-foreground w-full h-full" },
                            React.createElement(Errorpanel, null),
                            React.createElement(Tabs, { value: segmentKey, onValueChange: (v) => vizStore.setSegmentKey(v), className: "w-full h-full flex flex-col" },
                                !hideSegmentNav && (React.createElement(TabsList, { className: "mx-4" },
                                ...
                                React.createElement(TabsContent, { value: ISegmentKey.data },
                                    React.createElement("div", { className: "mx-4 -mt-px p-4 border rounded-md rounded-t-none" },
                                        React.createElement(DatasetConfig, { hideProfiling: hideProfiling }))),
                                React.createElement(TabsContent, { value: ISegmentKey.vis, className: "flex-1 min-h-0 flex flex-col" },
                                    !props.hideChartNav && (React.createElement("div", { className: "px-2 mx-2 mt-2" },
                                        React.createElement(VisNav, null))),
                                    React.createElement("div", { style: { marginTop: '0em' }, className: cn('m-4 p-4 border border-border rounded-md rounded-tl-none flex-1 min-h-0 flex flex-col', props.hideChartNav ? 'border-t-0 rounded-t-none' : '') },
                                        ...
                                        React.createElement(ExplainData, { themeKey: appliedThemeKey }),
                                        vizStore.showDataBoard && React.createElement(DataBoard, { hideProfiling: hideProfiling }),
                                        ...
                                        React.createElement(FieldConfigDialog, null),
                                        React.createElement(ComputedFieldDialog, null),
                                        React.createElement(Painter, { themeConfig: appliedThemeConfig, themeKey: appliedThemeKey }),
                                        vizStore.showGeoJSONConfigPanel && React.createElement(GeoConfigPanel, { geoList: props.geoList }),
                                        React.createElement("div", { className: "sm:flex flex-1 min-h-0" },
                                            React.createElement(SideResize, { defaultWidth: 240, handleWidth: 4, className: "min-w-[100%] max-w-full sm:min-w-[96px] sm:max-w-[35%] flex-shrink-0 sm:min-h-full flex flex-col", handlerClassName: "hidden sm:block" },
                                                React.createElement(DatasetFields, null)),
                                            React.createElement(SideResize, { defaultWidth: 180, handleWidth: 4, className: "min-w-[100%] max-w-full sm:min-w-[164px] sm:max-w-[314px] flex-shrink-0 flex flex-col", handlerClassName: "hidden sm:block" },
                                                React.createElement(FilterField, null),
                                                React.createElement(AestheticFields, null)),
                                            React.createElement("div", { className: "flex-1 min-w-[0px] flex flex-col" },
                                                React.createElement("div", null,
                                                    React.createElement(PosFields, null)),
                                                React.createElement("div", { className: "my-0.5 sm:ml-0.5 p-1 border relative flex-1 min-h-0", onMouseLeave: () => {
                                                        vizEmbededMenu.show && vizStore.closeEmbededMenu();
                                                    }, onClick: () => {
                                                        vizEmbededMenu.show && vizStore.closeEmbededMenu();
                                                    } },
                                                    computation && (React.createElement(ReactiveRenderer, { csvRef: downloadCSVRef, ref: rendererRef, vizThemeConfig: currentTheme, computationFunction: wrappedComputation, 
