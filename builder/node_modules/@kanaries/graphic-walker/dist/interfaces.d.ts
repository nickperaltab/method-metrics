...
export type IPreDefinedColorSchemes = keyof (typeof ColorSchemes)['discrete'] | keyof (typeof ColorSchemes)['single'] | keyof (typeof ColorSchemes)['multi'] | keyof (typeof ColorSchemes)['deiverging'] | keyof (typeof ColorSchemes)['cyclical'];
export type IColorSchemes = IPreDefinedColorSchemes | {
...
export type IColorScale = IScale & {
    scheme?: IColorSchemes;
};
...
export type IGWProps = IAppI18nProps & IVizProps & IThemeProps & IErrorHandlerProps & {
...
export declare const IDataSourceEventType: {
    updateList: number;
    updateMeta: number;
    updateSpec: number;
    updateData: number;
