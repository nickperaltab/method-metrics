...
export function addTooltipEncode(encoding, details = [], defaultAggregated = false) {
    const encs = Object.keys(encoding)
        ...
        field: defaultAggregated && f.analyticType === 'measure' ? getMeaAggKey(f.fid, f.aggName, f.windowAgg) : f.fid,
        title: f.titleOverride ||
            (defaultAggregated && f.analyticType === 'measure' ? getMeaAggName(f.name, f.aggName, f.windowAgg) : f.name),
        type: f.semanticType,
    })));
