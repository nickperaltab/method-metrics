...
export declare function getMeaAggName(meaName: string, agg?: string | undefined, windowAgg?: IWindowAgg): string;
export declare function getMeaAggKey(meaKey: string, agg?: string | undefined, windowAgg?: IWindowAgg): string;
