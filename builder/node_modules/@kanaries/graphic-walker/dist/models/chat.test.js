...
const createTestChart = (defaultAggregated = true) => {
...
describe('toVegaSimplifiedWithAggergation', () => {
    it('restores base field names and adds aggregate metadata when defaultAggregated is true', () => {
        ...
        expect(spec.encoding?.y).toEqual(expect.objectContaining({
            field: 'reading score',
            aggregate: 'mean',
            title: 'mean(reading score)',
        }));
        expect(spec.encoding?.x).toEqual(expect.objectContaining({
            field: 'gender',
            type: 'nominal',
        }));
    });
