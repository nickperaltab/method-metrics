...
(function (Methods) {
    ...
    Methods[Methods["editField"] = 26] = "editField";
})(Methods || (Methods = {}));
const actions = {
    ...
    [Methods.applySort]: (data, sort) => {
        ...
        if (xField !== null && xField.analyticType === 'dimension' && yField !== null && yField.analyticType === 'measure') {
            return mutPath(data, 'encodings.columns', (cols) => replace(cols, cols.length - 1, (x) => ({
                ...x,
                sort,
                sortType: 'measure',
                sortList: undefined,
        ...
        if (xField !== null && xField.analyticType === 'measure' && yField !== null && yField.analyticType === 'dimension') {
            return mutPath(data, 'encodings.rows', (rows) => replace(rows, rows.length - 1, (x) => ({
                ...x,
                sort,
                sortType: 'measure',
                sortList: undefined,
    ...
    [Methods.editField]: (data, channel, index, newData) => {
        return mutPath(data, `encodings.${channel}`, (fields) => replace(fields, index, (field) => {
            const nextField = { ...field, ...newData };
