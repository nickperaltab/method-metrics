...
const DataBoard = observer(function DataBoardModal({ hideProfiling }) {
    ...
    return (React.createElement(Dialog, { open: showDataBoard, onOpenChange: () => {
        ...
        React.createElement(DialogContent, null,
            React.createElement("div", { className: "mt-4" },
                React.createElement(DataTable, { hideProfiling: hideProfiling, size: 100, computation: filteredComputation, metas: metas, disableFilter: true, displayOffset: config.timezoneDisplayOffset })))));
});
