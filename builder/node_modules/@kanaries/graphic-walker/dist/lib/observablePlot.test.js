jest.mock('@observablehq/plot', () => {
    class MockMark {
        ...
        constructor(name, opts = {}) {
            ...
            this.channels = {};
            if (opts.x)
                this.channels.x = { value: { label: opts.x } };
            if (opts.y) {
    ...
    const factory = (name) => (data, opts = {}) => new MockMark(name, opts);
    return {
        barY: factory('bar'),
        barX: factory('bar'),
        lineY: factory('line'),
        ...
        boxX: factory('box'),
        boxY: factory('box'),
        stackY: () => (opts) => ({ ...opts, stack: 'y' }),
        stackX: () => (opts) => ({ ...opts, stack: 'x' }),
    };
});
...
//# sourceMappingURL=observablePlot.test.js.map