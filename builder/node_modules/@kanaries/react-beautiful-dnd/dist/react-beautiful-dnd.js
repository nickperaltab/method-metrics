(function (global, factory) {
    ...
    const wrapWithConnect = WrappedComponent => {
      ...
      function ConnectFunction(props) {
        ...
        const ContextToUse = React.useMemo(() => {
          ...
          reactIs_2( /*#__PURE__*/React.createElement(propsContext.Consumer, null)) ? propsContext : Context;
        ...
        const renderedWrappedComponent = React.useMemo(() => {
          return (
            /*#__PURE__*/
            // @ts-ignore
            React.createElement(WrappedComponent, _extends$1({}, actualChildProps, {
  ...
  function useRegistry() {
    ...
    var cleanHandleRef = React.useRef();
    React.useEffect(function () {
  ...
  function useValidation$1(props, contextId, getRef) {
    ...
    useDevSetupWarning(function () {
      ...
      if (props.isEnabled) {
        !findDragHandle(ctx.body, contextId, id) ? "development" !== "production" ? invariant(false, prefix(id) + " Unable to find drag handle") : invariant(false) : void 0;
      }
    });
  }
  ...
  function Droppable(props) {
    ...
    function getClone() {
      ...
      return ReactDOM__default.createPortal(node, getContainerForClone ? getContainerForClone() : ctx.body);
    }
